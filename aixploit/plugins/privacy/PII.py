...
class PIIInjector(Attacker):
    """
    This plugin is responsible for launching PII injection attacks, 
...
class SinglePIIInjector(Attacker):
    """
    This plugin is responsible for launching a PII injection attack 
...
class PIIExtractor(Attacker):
    """
    This plugin is responsible for launching PII extraction attacks, 
    which involve manipulating input data to change the intended behavior of a system.
    """
    results = []
    def __init__(self, source: str, source_type: str ):  # {{ edit_1 }}
...
class SinglePIIExtractor(Attacker):
    """
    This plugin is responsible for launching a PII extraction attack 
    with a single prompt, which involves manipulating input data to change 
    the intended behavior of a system.
    """
    def __init__(self, prompt: str):  # {{ edit_1 }}
