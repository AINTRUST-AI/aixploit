...
class SensitiveDataInjector(Attacker):
    """
    This plugin is responsible for launching sensitive data injection attacks, 
...
class SingleSensitiveDataInjector(Attacker):
    """
    This plugin is responsible for launching a sensitive data injection attack 
...
class SensitiveDataExtractor(Attacker):
    """
    This plugin is responsible for launching sensitive data extraction attacks, 
    which involve manipulating input data to change the intended behavior of a system.
    """
    results = []
    def __init__(self, source: str, source_type: str ):  # {{ edit_1 }}
...
class SingleSensitiveDataExtractor(Attacker):
    """
    This plugin is responsible for launching a sensitive data extraction attack 
    with a single prompt, which involves manipulating input data to change 
    the intended behavior of a system.
    """
    def __init__(self, prompt: str):  # {{ edit_1 }}
