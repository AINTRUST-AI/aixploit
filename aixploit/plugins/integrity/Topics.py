...
class TopicInjector(Attacker):
    """
    This plugin is responsible for launching topics injection attacks, 
...
class SingleTopicInjector(Attacker):
    """
    This plugin is responsible for launching a topic injection attack 
