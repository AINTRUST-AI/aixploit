...
class IndirectPromptInjector(Attacker):
    """
    This plugin is responsible for launching indirect prompt injection attacks, 
...
class SingleIndirectPromptInjector(Attacker):
    """
    This plugin is responsible for launching a prompt injection attack 
