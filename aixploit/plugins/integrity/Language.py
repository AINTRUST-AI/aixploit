...
class LanguageInjector(Attacker):
    """
    This plugin is responsible for launching language attacks, 
...
class SingleLanguageInjector(Attacker):
    """
    This plugin is responsible for launching a language injection attack 
