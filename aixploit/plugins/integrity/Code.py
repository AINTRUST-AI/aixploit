...
class CodeInjector(Attacker):
    """
    This plugin is responsible for launching code injection attacks, 
...
class SingleCodeInjector(Attacker):
    """
    This plugin is responsible for launching a code injection attack 
