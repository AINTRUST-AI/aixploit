...
class ToxicityInjector(Attacker):
    """
    This plugin is responsible for launching toxicity injection attacks, 
...
class SingleToxicityInjector(Attacker):
    """
    This plugin is responsible for launching a toxicity injection attack 
