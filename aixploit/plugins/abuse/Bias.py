...
class BiasInjector(Attacker):
    """
    This plugin is responsible for launching bias injection attacks, 
...
class SingleBiasInjector(Attacker):
    """
    This plugin is responsible for launching a bias injection attack 
