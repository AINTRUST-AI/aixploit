...
- A dictionary mapping each attacker's name to its conversation (prompts + responses).
- A dictionary mapping each attacker's name to its successful malicious conversations (prompts + responses).
